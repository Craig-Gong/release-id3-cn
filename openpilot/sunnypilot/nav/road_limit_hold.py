"""Debounce Gaode nRoadLimitSpeed before HUD / MAX adoption.

Gaode BLE/UDP updates can flutter one step (e.g. 60↔80) without a real zone
change. Camera VZE already uses a 1.5 s hold; map limits adopt faster on
decreases (real zones) and slower on large jumps (glitches).
"""
