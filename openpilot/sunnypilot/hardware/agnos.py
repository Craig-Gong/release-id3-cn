...
# Known-good C3XL boot chain: AGNOS 15.1 ABL + 18 MiB kernel, with AGNOS 19.6
# system. Same hashes as mr-one/openpilot:c3xl-dev and onemiless/dev-sp-egpu.
# Official 19.6 ABL (29fd7ed1…) / 45 MiB kernel (b30f5eef…) are refused.
...
def validate_agnos_manifest(partitions: Sequence[dict], profile: HardwareProfile | None = None) -> None:
  # This tree is C3XL-only. Always enforce the allowlist so a missed profile
  # (no cameras yet in recovery / QDL) cannot flash official 19.6/19.7 ABL.
  del profile
