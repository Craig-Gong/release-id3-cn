...
def _load_planner_cls():
  from iqpilot.selfdrive.controls.lib.longitudinal_planner import LongitudinalPlannerIQ
...
def test_remain_s_1_waits_on_close_lead():
  from iqpilot.selfdrive.controls.lib.helpers.green_follow_lead import LEAD_GO_CONFIRM_S, LEAD_GO_SPEED_MPS
